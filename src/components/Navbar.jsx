...
const Navbar = () => {
    return (
        <>
            <div className="grid grid-cols-3 gap-7 w-11/12 md:w-4/5 mx-auto sm:py-8 py-6 relative">
                ...
                <div className='max-h-56'>
                    <ul className='flex gap-9 cursor-pointer justify-center font-primary font-normal items-center py-3 text-s '>
                        ...
                        <li className='hidden md:block group '>
                            Category
                            {/* dropdown categories */}
                            <div className="dropdownp-5 pt-10 left-0 z-10 absolute md:w-full hidden group-hover:block rounded">
                                <div className="card bg-gray-950/90 flex justify-between p-10">
                                    <div>
