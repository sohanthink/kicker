    ...
    return (
        <>
            <div className='w-11/12 mx-auto'>
                <Image className="w-full h-screen" source="https://images.pexels.com/photos/2127041/pexels-photo-2127041.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2" />
            </div>

            <div className='mx-auto space-y-4 py-14 font-primary w-2/4'>
